...
L.Yandex = L.Layer.extend({
    ...
    initialize: function (type, options) {
      ...
      this._isOverlay =
        options.type.indexOf("overlay") !== -1 ||
    ...
    _initContainer: function (parentEl) {
      var zIndexClass = this._isOverlay
        ? "leaflet-overlay-pane"
        : "leaflet-tile-pane";
      var _container = L.DomUtil.create(
        "div",
        "leaflet-yandex-container leaflet-pane " + zIndexClass
      );
      var opacity =
        this.options.opacity || (this._isOverlay && this.options.overlayOpacity);
      if (opacity) {
    ...
    _update: function () {
      ...
      var offset = L.point(0, 0).subtract(
